    ...
    <div>
        ...
        <div class="q-pa-md">
            ...
            <template v-slot:body-cell-action="props">
                <q-td :props="props">
                      <q-btn class="q-mr-sm" flat rounded unelevated size="12px" text-color="grey-8" icon="edit" @click="showEdit(props.row)"/>
                      <q-btn class="q-mr-sm" flat rounded unelevated size="12px" text-color="grey-8" icon="delete_outline" @click="deletePhoto(props.row)"/>
                </q-td>
            </template>
